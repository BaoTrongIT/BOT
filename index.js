...
const dashboard = http.createServer(function (_req, res) {
    ...
    res.write("This Bot made By Lazic Team");
    res.end();
});

dashboard.listen(process.env.port || 0);

logger("Đang mở website", "[ DONE - LAZICTEAM ]");
...
function startBot(message) {
    (message) ? logger(message, "[ Đang Mở ]") : "";
...
}).catch(err => logger("Không Thể Check update", "[ CHECK UPDATE ]"));
