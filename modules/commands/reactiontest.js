...
module.exports.run = async ({ event, api, client }) => {
    api.sendMessage("Đo Tốc Độ Cào Phím !",event.threadID,event.messageID);
    ...
    return api.sendMessage(`Ghi [ ${word} ] Ngay Bây Giờ!!!`, event.threadID, async () => {
